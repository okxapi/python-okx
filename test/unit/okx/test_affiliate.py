...
class TestAffiliateAPI(unittest.TestCase):
    ...
    def test_get_invitee_detail(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_invitee_detail(uid='123456')
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_INVITEE_DETAIL, {'uid': '123456'})

    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_invitee_list_default(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_invitee_list()
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_INVITEE_LIST, {})

    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_invitee_list_with_params(self, mock_request):
        mock_request.return_value = {'code': '0'}
        fee_tier = ['0', '10']
        self.api.get_invitee_list(
    ...
    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_link_list_default(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_link_list()
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_LINK_LIST, {})

    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_link_list_with_params(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_link_list(
    ...
    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_performance_summary_default(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_performance_summary()
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_PERFORMANCE_SUMMARY, {})

    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_performance_summary_with_params(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_performance_summary(periodType='custom', begin='1', end='2')
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_PERFORMANCE_SUMMARY,
            {'periodType': 'custom', 'begin': '1', 'end': '2'})

    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_tier_breakdown_default(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_tier_breakdown()
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_TIER_BREAKDOWN, {})

    @patch.object(AffiliateAPI, '_request_with_params')
    def test_get_tier_breakdown_with_params(self, mock_request):
        mock_request.return_value = {'code': '0'}
        self.api.get_tier_breakdown(periodType='this_month', begin='1', end='2')
        mock_request.assert_called_once_with(
            c.GET, c.AFFILIATE_TVB_TIER_BREAKDOWN,
